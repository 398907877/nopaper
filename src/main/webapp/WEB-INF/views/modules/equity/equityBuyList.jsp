...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="equity:equityBuy:edit"><li ><a href="${ctx}/equity/equityBuy/form">股票买入</a></li></shiro:hasPermission>
		<li   class="active"><a href="${ctx}/equity/equityBuy/">股票买入记录</a></li>
	</ul>
