...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/equity/equitySell/form?id=${equityTrading.id}">股票卖出<shiro:hasPermission name="equity:equitySell:edit"></shiro:hasPermission><shiro:lacksPermission name="equity:equitySell:edit">查看</shiro:lacksPermission></a></li>
	<li><a href="${ctx}/equity/equitySell/list">股票卖出记录</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="equitySell" action="${ctx}/equity/equitySell/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="equity:equitySell:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
